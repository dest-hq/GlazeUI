use wgpu::{
    ...
    Limits, LoadOp, MultisampleState, Operations, PowerPreference, Queue,
    RenderPassColorAttachment, RenderPassDepthStencilAttachment, RenderPassDescriptor,
    RequestAdapterOptions, StencilState, StoreOp, Surface, SurfaceConfiguration, TextureDescriptor,
...
use crate::{Area, Atlas, Item, Renderer};
...
impl Canvas {
    ...
    pub async fn new<W: WindowHandle + 'static>(window: W, width: u32, height: u32) -> Self {
        ...
        limits.max_texture_dimension_2d = if cfg!(target_os = "android") {
            4096
        } else {
            8192
        };
        ...
        if width > limits.max_texture_dimension_2d || height > limits.max_texture_dimension_2d {
            panic!(
                "Width or Height exceeded max texture dimension {}",
